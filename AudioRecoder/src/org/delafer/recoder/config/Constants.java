...
public class Constants
{
  ...
  public static final Date RELEASE_DATE = UtilsCommon.asDate("10.05.2011");
  ...
  public static final String BENCHMARK_VERSION  = "1.0.0.0";  //2.5.0.1_CVS
  public static final byte[] VERSION_ID       = ("JSBN001").getBytes();  //MUST be 8 chars long!
