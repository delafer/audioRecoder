...
import org.delafer.recoder.config.Constants;
...
public class RepositoryImages {
	...
	public static void loadImagesForSplashWindow(Display display) {
		RepositoryImages.display = display;
	}

	public static void loadImages(Display display) {

		addPath("org/delafer/recoder/resources/icons/cpu.png", "main_icon");
	...
	private static Image loadImage(Display display, String res, String name,
			int alpha) {
		return loadImage(RepositoryImages.class.getClassLoader(), display, res,
				name, alpha);
	}
	...
	public static InputStream getImageAsStream(String name) {
		...
		return RepositoryImages.class.getClassLoader().getResourceAsStream(path);
	}
	 ...
	 * @see RepositoryImages#getPathIcon(String)
	 */
